...
public class Ladrao extends ProgramaLadrao {
    ...
    /**
    * Retorna a direção que dever ser andada nessa rodada, com base nos melhores caminhos possíveis encontrados.
     **/
	public int acao() {
	...
	/**
	* Acha o caminho com menor peso andando pela direita na matriz, e retorna o seu peso.
     *Para fazer o mesmo para outro lado, basta rotacionar a matriz com rotacionaMatriz()
	 **/
    ...
    /**
    * Retorna o peso baseado num código.
     * 0 significa espaço vazio,
     * -100 significa um poupador,
     * Qualquer outra coisa é considerado um obstáculo e recebe um número bem alto.
     **/
	...
	* Gira a matriz 90 graus para a direita
	...
	private void rotacionaMatriz(int[][] matriz){
        ...
        for (int i = 0; i < matriz[0].length; i++) {
            for (int j = 0, k = matriz[0].length - 1;
                 j < k; j++, k--) {
                temp = matriz[i][j];
	...
	/**
	* Inicializa os caminhos que vão ser usados para checar no menorPesoDireita().
     * Esses caminhos são caminhos para posiçòes que seriam interessantes de chegar por um lado.
	 **/
